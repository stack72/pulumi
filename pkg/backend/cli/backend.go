...
func (b *Backend) DefaultSecretsManager() string {
	return b.client.DefaultSecretsManager()
}
...
func (b *Backend) ParsePolicyPackIdentifier(s string) (PolicyPackIdentifier, error) {
	currentUser, err := b.CurrentUser()
	if err != nil {
		currentUser = ""
	}
	return ParsePolicyPackIdentifier(s, currentUser, b.client.URL())
}
